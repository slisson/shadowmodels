...
<model ref="r:a6bc822a-e7bc-4268-bf29-b2a032b8a774(de.q60.mps.shadowmodel.demolang.blext.editor)">
  ...
  <imports>
    ...
    <import index="prps" ref="r:1349fda1-905b-4e8f-847a-6db91f972f07(de.q60.mps.shadowmodel.demolang.blext.structure)" />
  ...
  <node concept="24kQdi" id="6QszampOHqa">
    <ref role="1XX52x" to="prps:6QszampOHpW" resolve="UnlessStatement" />
