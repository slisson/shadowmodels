...
<model ref="r:ab664764-0ac7-4a95-9554-436b8431d0d9(de.q60.mps.shadowmodel.util.editor)">
  ...
  <imports>
    ...
    <import index="myud" ref="r:d30ac2ce-6230-4593-a70d-e5bfdefa5307(de.q60.mps.shadowmodel.util.structure)" implicit="true" />
  </imports>
  <registry>
  ...
  <node concept="24kQdi" id="2af7$rtsksk">
    <ref role="1XX52x" to="myud:2af7$rtrDWk" resolve="CellModel_CustomFactory" />
      ...
      <node concept="3EZMnI" id="hF4$qDk" role="3EZMnx">
        <node concept="3EZMnI" id="h7YsR5r" role="3EZMnx">
          ...
          <node concept="3F1sOY" id="h7YsRBk" role="3EZMnx">
            <ref role="1NtTu8" to="myud:2af7$rtssdJ" resolve="factoryMethod" />
          </node>
  ...
  <node concept="3p36aQ" id="4iNiUqGz3jw">
    <ref role="aqKnT" to="myud:gTQ80DJ" resolve="ConceptFunctionParameter_cell" />
  </node>
</model>
