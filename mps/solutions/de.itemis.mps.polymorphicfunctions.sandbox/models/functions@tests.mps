...
<model ref="r:775db337-196b-4586-ac45-7d35b1989cd0(de.itemis.mps.polymorphicfunctions.sandbox.functions@tests)">
  ...
  <imports>
    <import index="97nk" ref="r:988aa023-0cd7-4d23-aafa-c88605596386(de.itemis.mps.polymorphicfunctions.sandbox.functions)" />
    ...
    <import index="e9uj" ref="r:a0737da3-c8e0-437c-a9b2-5b254393a0a1(de.itemis.mps.polymorphicfunctions.behavior)" />
    <import index="5hsq" ref="r:a33c4073-060a-44ab-9859-9e963168fb14(de.itemis.mps.polymorphicfunctions.sandbox.input)" />
